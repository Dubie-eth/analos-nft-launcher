...
// CollectionInfo interface removed - no longer needed
...
export default function ProfilePage() {
  ...
  // Collections removed from profile page
  ...
  // Collections function removed - no longer needed
  ...
  return (
    <StandardLayout className="p-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Collections section removed - users can browse collections via the Collections tab */}
