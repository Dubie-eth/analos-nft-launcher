-- AIRDROP CAMPAIGN DATABASE SCHEMA
-- Secure database storage for airdrop campaigns and claims
...
-- Apply triggers
CREATE TRIGGER update_airdrop_campaigns_updated_at BEFORE UPDATE ON airdrop_campaigns FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_airdrop_claims_updated_at BEFORE UPDATE ON airdrop_claims FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
