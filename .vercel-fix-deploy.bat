...
git commit -m "Fix: Resolve Vercel PostCSS/webpack build error - Update postcss.config.js format for Next.js 15 compatibility - Add vercel.json with proper build configuration - Create alternative postcss.config.mjs backup - Force clean npm install on Vercel"
