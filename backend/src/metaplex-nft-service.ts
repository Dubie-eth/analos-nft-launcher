...
export class MetaplexNFTService {
  ...
  /**
   * Create a standard Solana NFT using basic SPL Token operations
   * This creates a functional NFT that can be viewed and traded on Analos
   */
  async createNFT(
    ...
    try {
      console.log('🎨 Creating NFT using standard Solana/SPL Token approach...');
      ...
      if (typeof signedTransaction === 'string') {
        ...
        const signature = await this.connection.sendRawTransaction(
          signedTransaction instanceof Transaction ? signedTransaction.serialize() : signedTransaction, 
          {
            skipPreflight: false,
