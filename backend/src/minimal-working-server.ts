 ...
 * Simplified version to get backend running
 */
...
console.log('🚀 Starting Minimal Analos NFT Launcher Backend Server...');
...
app.get('/health', (req, res) => {
  res.json({ 
    ...
    service: 'Analos NFT Launcher Backend (Minimal)',
    version: '2.0.4',
    environment: {
      port: PORT,
      analosRpcUrl: ANALOS_RPC_URL,
...
// Start the server
app.listen(PORT, () => {
  console.log(`🚀 Minimal Analos NFT Launcher Backend Server running on port ${PORT}`);
